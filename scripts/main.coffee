...
class EventListCtrl
  ...
  DATA = {
    "last_update": "2013-09-05T04:20:35.010Z",
    "events": [
      {
        "day": 30,
        "month": "авг",
      ...
      },
      {
        ...
        "body": "<b>С 6 по 8 сентября</b> паломническая поездка с послушанием в Свято-Елисеевский мужской монастырь в Лавришево<br><ul><li>Постельные принадлежности выдадут</li><li>Кормить будут</li><li>Взять теплые вещи — осень на дворе</li><li>Старшим в группах взять по чайнику</li></ul>",
...
app.controller "EventListCtrl", ["$scope", "$sce", EventListCtrl]
